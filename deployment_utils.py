...
doc2vec_model_embeddings = Doc2Vec.load(
    "/home/harshwardhan/Project/Court-smart/models/best_doc2vec_embeddings")
doc2vec_model = keras.models.load_model(
    "/home/harshwardhan/Project/Court-smart/models/best_doc2vec_model.h5")
tfidf_model = keras.models.load_model(
    "/home/harshwardhan/Project/Court-smart/models/best_tfidf_model.h5")
cnn_model = keras.models.load_model(
    "/home/harshwardhan/Project/Court-smart/models/best_cnn_model.h5")
glove_model = keras.models.load_model(
    "/home/harshwardhan/Project/Court-smart/models/best_glove_model.h5")
lstm_model = keras.models.load_model(
    "/home/harshwardhan/Project/Court-smart/models/best_lstm_model.h5")
bert_model = keras.models.load_model(
    "/home/harshwardhan/Project/Court-smart/models/best_bert_model.h5", custom_objects={"TFBertModel": transformers.TFBertModel})
fasttext_model = fasttext.load_model(
    "/home/harshwardhan/Project/Court-smart/models/best_fasttext_model.bin")
...
class Predictor:
    ...
    def summarize_facts(self, facts: str) -> str:
        ...
        while remaining_facts:
            # Truncate the remaining facts to match the expected max_length
            truncated_facts = remaining_facts[:500]
            remaining_facts = remaining_facts[500:]

            # Summarize the truncated facts using BART model
            summarized_chunk = summarization_model(truncated_facts)[0]['summary_text']

            # Append the summary to the existing summarized_facts
            summarized_facts_1 += summarized_chunk + "\n"

        return summarized_facts_1
