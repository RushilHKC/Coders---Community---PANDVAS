...
petitioner = respondent = case_facts = ""
...
with open("/home/harshwardhan/Project/Court-smart/src/style.css") as f:
    ...
    with st.expander(label="Case Summarizer", expanded=True):
        ...
        if option == "Upload a File":
            ...
            case_facts = st.text_area(
                label="Enter your Case Facts yourself", height=250)
...
def predict_outcome():
    ...
    # Add your existing code for the "Predict the Outcome" section here...
...
if "section" in params and params["section"] == "predict_outcome":
    predict_outcome()
else:
    summarize_case()
    st.markdown("[Predict Outcome](?section=predict_outcome)")
